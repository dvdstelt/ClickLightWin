...
public sealed class Settings : INotifyPropertyChanged
{
    ...
    private HotKeyBinding _zoomHotKey = HotKeyBinding.DefaultZoom;
    ...
    public HotKeyBinding ZoomHotKey { get => _zoomHotKey; set => Set(ref _zoomHotKey, value); }
